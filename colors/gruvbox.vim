...
let s:gb.dark0       = ['#2A2426', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#32302f', 236]     " 50-48-47
let s:gb.dark1       = ['#242021', 237]     " 60-56-54
let s:gb.dark2       = ['#242021', 239]     " 80-73-69
let s:gb.dark3       = ['#242021', 241]     " 102-92-84
let s:gb.dark4       = ['#7c6f64', 243]     " 124-111-100
let s:gb.dark4_256   = ['#7c6f64', 243]     " 124-111-100

let s:gb.gray_245    = ['#837568', 245]     " 146-131-116
let s:gb.gray_244    = ['#837568', 244]     " 146-131-116
...
let s:gb.bright_red     = ['#e68183', 167]     " 251-73-52
let s:gb.bright_green   = ['#adbe5f', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#d9bb80', 214]     " 250-189-47
let s:gb.bright_blue    = ['#94c4c0', 109]     " 131-165-152
let s:gb.bright_purple  = ['#d7a9c2', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#a5c7a3', 108]     " 142-192-124
let s:gb.bright_orange  = ['#e39b7b', 208]     " 254-128-25

let s:gb.neutral_red    = ['#e68183', 124]     " 204-36-29
let s:gb.neutral_green  = ['#a7c080', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#d9bb80', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#89beba', 66]      " 69-133-136
let s:gb.neutral_purple = ['#d3aobc', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#87c095', 72]      " 104-157-106
let s:gb.neutral_orange = ['#e39b7b', 166]     " 214-93-14
